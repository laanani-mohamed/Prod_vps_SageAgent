"""
bi/referentiel/use_cases/doc_entete_uc.py
"""
from api.referentiel.schemas import DocEnteteRequest, ReferentielResponse
...
def execute(req: DocEnteteRequest) -> ReferentielResponse:
    repo = get_repo("doc_entete", req.source_type)
    ...
    return ReferentielResponse(
        ...
        source=source,
        message=None if data else "document introuvable",
        total_rows=len(data),
        data=data,
    )
